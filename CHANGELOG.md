...
## [1.1.4] - 2026-09-03 — maintenance release preparation
...
- The committed frontend lockfile is regenerated by the supported npm workflow after frontend manifest changes.
...
- The failed `v1.1.3` tagged workflow run is retained as diagnostic history; existing tags and published releases must not be rewritten.
